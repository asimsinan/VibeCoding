...
import { CourseForm, Alert, AlertDescription, Button } from '@/components/ui';
...
export default function NewCoursePage() {
  ...
  const handleSubmit = async (data: CourseFormData) => {
    try {
      ...
      const response = await apiClient.post('/api/instructor/courses', courseData) as { id: string };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-white via-primary-50 to-primary-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">You need to be logged in to create courses.</p>
        ...
        <div className="w-64 bg-white/80 backdrop-blur-lg border-r border-gray-200 shadow-lg">
          <div className="p-6">
            ...
            <nav className="space-y-3">
              ...
              <Link href="/instructor/courses/new" className="flex items-center px-4 py-3 text-sm font-medium text-red-600 bg-red-50 rounded-xl hover:bg-red-100 transition-all duration-200 group">
                <svg className="w-5 h-5 mr-3 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">

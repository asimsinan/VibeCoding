...
import { UserCard, Button, Input, Select, Modal, Alert, AlertDescription } from '@/components/ui';
...
export default function UsersPage() {
  ...
  const fetchUsers = async () => {
    try {
      setLoading(true);
      const usersData = await apiClient.get<User[]>('/api/admin/users');
      setUsers(usersData);
    } catch (error) {
  ...
  const handleToggleUserStatus = async (user: User) => {
    try {
      await apiClient.put(`/api/admin/users/${user.id}/toggle-status`);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-white via-red-50 to-red-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">You need to be logged in to manage users.</p>
          ...
          <div className="px-8 py-6">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="text-gray-600 font-medium">Manage users and their permissions</p>
              </div>

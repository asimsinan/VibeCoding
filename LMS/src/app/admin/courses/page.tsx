...
export default function AdminCoursesPage() {
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      ...
      try {
        setLoading(true);
        const coursesData = await apiClient.get<Course[]>('/api/admin/courses');
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-white via-red-50 to-red-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">You need to be logged in to manage courses.</p>
          ...
          <div className="px-8 py-6">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="text-gray-600 font-medium">Manage all courses in your organization</p>
              </div>
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredCourses.map((course) => (
              <Card key={course.id} className="hover:shadow-lg transition-shadow duration-200 border border-red-200">
                <CardHeader className="bg-red-50 border-b border-red-200">
                  <CardTitle className="text-red-700 text-lg">{course.title}</CardTitle>
                </CardHeader>
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="text-gray-900 font-medium">{course.enrollmentsCount}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-500">Modules:</span>
                      <span className="text-gray-900 font-medium">{course.modulesCount}</span>
                    </div>
                    <div className="flex justify-between text-sm">

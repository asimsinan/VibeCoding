...
declare namespace __next_route_internal_types__ {
  ...
  type DynamicRoutes<T extends string = string> = 
    | `/api/v1/boards/${SafeSlug<T>}`
    | `/api/v1/boards/${SafeSlug<T>}/tasks`
    | `/api/v1/tasks/${SafeSlug<T>}`
    | `/api/v1/tasks/${SafeSlug<T>}/move`
    | `/api/v1/workspaces/${SafeSlug<T>}`
    | `/api/v1/workspaces/${SafeSlug<T>}/boards`
    | `/api/v1/workspaces/${SafeSlug<T>}/invite`

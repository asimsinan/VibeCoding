      ...
      <div className="relative z-10 max-w-md w-full">
        <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-10 transform transition-all hover:shadow-3xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 font-light">Hesabınıza hoş geldiniz</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              Hesabınız yok mu?{' '}
              <Link href="/register" className="text-[#1A237E] font-semibold hover:underline transition-all hover:text-[#283593]">
                Kayıt Ol
              </Link>
            </p>
          </div>
